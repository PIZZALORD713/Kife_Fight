...
export function CountdownScreen({ countdown, stakeAmount, roundNumber }) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-3 p-6">
      <div className="text-red-400 font-black uppercase tracking-widest text-xs">Round {roundNumber}</div>
      <div className="text-gray-400 uppercase tracking-widest text-sm">Get ready...</div>
